...
const AppointmentList = ({appointments, handleDelete, handleDoubleClick}) => {
  ...
  return (
    <Container className="p-2">
      ...
      {appointments.length === 0 ? (<img src="./img/appointment.jpg" alt="appointments" width="70%"/>) :
        appointments.map(({id, patient, consulted, doctor, day}) => (
          <div key={id} className={"appointments " + (consulted && "consulted")} role="button" onDoubleClick={() => handleDoubleClick(id)}>
